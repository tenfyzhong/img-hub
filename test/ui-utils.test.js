...
test("share formats provide raw URL, Markdown, and safe HTML", () => {
    const formats = buildShareFormats({
        ...
        url: "https://img.example.com/pub/0123456789abcdef0123456789abcdef?v=0&download=1",
    });

    assert.equal(formats.url, "https://img.example.com/pub/0123456789abcdef0123456789abcdef?v=0&download=1");
